...
export default function RegisterPage() {
  ...
  const handleRegister = (e: React.FormEvent) => {
    ...
    toast({ title: `Registered as ${role}!` });
    if (role === "master") navigate("/master/profile");
    else navigate("/student/signup");
  };
        ...
        <div className="rounded-xl border border-border bg-card p-6">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div>
              ...
              <Input id="confirm" type="password" placeholder="••••••••" value={form.confirmPassword} onChange={(e) => setForm({ ...form, confirmPassword: e.target.value })} />
            </div>
